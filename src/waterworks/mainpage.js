...
export default function MainPage() {
  ...
  return (
    <div className="overflow-x-hidden font-Anek overflow-x-hidden">
      <div className="flex flex-col sm:flex-row max-w-screen">
        <img
          src={WaterBottle}
          className="rounded-lg sm:w-96 lg:w-[400px]"
        ></img>
        <div className="font-bold text-2xl mt-10 sm:mt-0 hidden sm:flex sm:text-5xl lg:text-7xl flex sm:border-l-8 sm:border-blue-300 items-center rounded-2xl sm:bg-gray-100 sm:ml-8 sm:rounded-l-lg justify-center p-4 leading-10 tracking-lg">
          <div className="">
            ...
            Yet full of healthy minerals, Just for{" "}
      ...
      <div className="flex max-w-screen overflow-x-hidden sm:mt-16 mt-10 hidden sm:flex">
        <div className="font-bold text-2xl sm:text-5xl lg:text-7xl flex items-center mb-4 sm:mb-0 bg-gray-100 border-r-8 border-black mr-6 sm:mr-8 rounded-r-lg justify-center text-gray-700 sm:p-6 p-6 leading-12 tracking-lg">
          <div>
            Sourced From the <span className="text-green-400">Springs</span> of
            Abuja, and Engineered to keep you on the{" "}
        ...
        <img
          src={ManDrinking}
          className="sm:h-full h-32 w-screen -mr-6 object-cover self-end sm:w-fit object-left rounded-l-lg sm:mr-4 sm:max-h-[600px]"
        ></img>
      </div>
      ...
      <div className="flex items-center justify-center mt-24 sm:hidden">
        <div className="w-64 ">
          ...
          <div className="p-8 rounded-b-3xl bg-gray-100 text-xl bg-black text-white">
            Sourced From the{" "}
            <span className="text-green-400 font-bold">Springs </span>
            of Abuja, and Engineered to keep you on the{" "}
            <span className="text-green-400">Go!</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center mt-20 text-white">
        <div className="flex flex-col md:flex-row justify-between md:items-stretch md:w-4/5 items-center justify-center">
          <div className="md:p-15 lg:p-20 p-10 md:ml-2 bg-black md:w-96 w-72 rounded-lg mb-4 md:mb-0">
            {vapourIcon}
            <div className="">Vapour Distilled</div>
            <div className="text-sm">
              Every batch of water passes through a series of machines and
              through a Vapour distillation proccess which guarantees maximum
              purity.
            </div>
          </div>
          <div className="md:p-15 p-10 lg:p-20  md:ml-2 bg-black md:w-96 w-72 rounded-lg mb-4 md:mb-0">
            {transportIcon}
            <div className="">Free deliverly for orders over #100,000.</div>
          </div>
          <div className="md:p-15 p-10 lg:p-20  md:ml-2 bg-black md:w-96 w-72 rounded-lg">
            {peopleIcon}
            <div className="">
              Join our community, stay abreast with our new technologies and
      ...
      <div className="w-full mt-20">
        <div className="md:p-20 p-10 flex flex-col items-center justify-center bg-gray-100">
          <div className="p-3 bg-green-300 rounded-full ">{leafIcon}</div>
          <div className="sm:text-3xl text-2xl text-center">
            Clean Water Initiative
          </div>
          <p className="md:text-2xl text-xl text-center text-blue-300 ">
      ...
      <div className="mt-20 bg-blue-800 p-20 text-white flex flex-col items-center justify-center">
        <div>SignUp and stay updated</div>
        <form className="flex flex-col mt-2">
          ...
          ></input>
          <button className="bg-white p-2 text-black mt-4 hover:bg-green-400 hover:text-white">
            SignUp
          </button>
        </form>
        <div className="mt-10">Find us @</div>
        <div className="flex">
          <button className="p-2">{twitterIcon}</button>
          <button className="p-2">{faceBookIcon}</button>
          <button className="p-2">{instagramIcon}</button>
        </div>
      </div>
    </div>
  );
